package com.oxchains.gcp.thread;

import com.oxchains.gcp.channel.ConnectionPartition;
import com.oxchains.gcp.channel.MChannelPool;
import com.oxchains.gcp.channel.ManagedChannelHandle;
...
public class ConnectionTesterThread implements Runnable {
	...
	public ConnectionTesterThread(ConnectionPartition connectionPartition, ScheduledExecutorService scheduler,
