package com.oxchains.gcp.channel;
...
public class ConnectionPartition implements Serializable {
	...
	public ReentrantReadWriteLock statsLock = new ReentrantReadWriteLock();
	...
	public void updateCreatedConnections(int increment) {
		try {
	...
	public void addFreeConnection(ManagedChannelHandle managedChannel) throws SQLException {
	...
	public BlockingQueue<ManagedChannelHandle> getFreeConnections() throws Exception {
		return this.freeConnections;
	}

	public ManagedChannelHandle getManagedChannelHandle() throws Exception {
	...
	public void setFreeConnections(BlockingQueue<ManagedChannelHandle> freeConnections) throws Exception {
	...
	public void maybeSignalForMoreConnections() {
	...
	public int getCreatedConnections() throws Exception {
		try {
